...
Правило обработки пустого пула:

- если провайдер возвращает 0 прокси, это не ошибка; updater продолжает работать
- ошибкой считаются только сетевые/контрактные проблемы API
